...
{
    [SerializeField] float maxSlopeAngle = 75;
    ...
    void VerticalCollisions(ref Vector2 moveAmount)
    {
        ...
        for (int i = 0; i < verticalRayCount; i++)
        {
            ...
            if (hit)
            {
                if (hit.collider.tag == "Through" || hit.collider.tag == "MovingThrough")
                {
                    if (directionY == 1 || hit.distance == 0)
                    {
                        ...
                        if (hit.collider.tag == "MovingThrough" && !collisions.below)
                        {
                            continue;
                        }
                    }
        ...
        //Debug.Log("[Controller2D.cs/VerticalCollisions()] moveAmount.y = " + moveAmount.y);
    }
